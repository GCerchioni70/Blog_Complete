# Lesson 69 from Udemy Course
# Added: use of git to connect to Git Hub Remote Repository
# Added: ### You can allow the user who commented to delete the comment.
# Added: you can add time(showing days, hours, mins and just now) to the comment
# from  Akhinh
...
# Create a Comment table for users that have commented
class Comment(db.Model):
...
# This is the function calculating the days, hours, mins and just now
...
# additional code to the show_post route(the show_post function)
...
def show_post(post_id):
    ...
    # updating the time and turning it to list. note: this doesn't affect the data(time) in posted_time in the
    # comment query
    the_time = []
...
# You can allow the user who commented to delete the comment.
